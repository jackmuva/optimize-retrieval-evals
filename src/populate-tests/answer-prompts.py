...
# loop_prompts("nosum_", "hybrid", 5, True, False, 500)
loop_prompts("noreranknosum_", "hybrid", 5, False, False, 500)
loop_prompts("noreranksum_", "hybrid", 5, False, True, 500)
loop_prompts("denseopt_", "dense", 5, True, True, 500)
loop_prompts("densenosum_", "dense", 5, True, False, 500)
loop_prompts("densenoreranknosum_", "dense", 5, True, False, 500)
